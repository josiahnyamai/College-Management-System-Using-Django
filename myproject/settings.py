...
SECRET_KEY = 'django-insecure-=!jj))n(t**t%9=14rk5x1*q*mdigf4@*$)e(4xx=z5^-mbygz'
...
LOGIN_REDIRECT_URL = 'dashboard'  # Redirects to student list after login
